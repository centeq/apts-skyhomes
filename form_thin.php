    ...
    <div class="row" >
      <div id="t_f_call" class="form-group col-sm-12">
        <div class="input-group"> <span class="input-group-addon"><span class="glyphicons  glyphicons-iphone" ></span></span>
          ...
          <input id="f_phonenumber" type="tel" class="form-control {validate:{required:true}}" name="<?= $FIELD_MOBI_PHONE ?>"  title="Phone Number Required" placeholder="Mobile Number *" value="<?=$phone?>" >
        </div>
      </div>
    </div>
  </fieldset>
