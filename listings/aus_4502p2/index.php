<div class="row listing-row"> 
  <!-- listing -->
  <div class="flag sold_flag"> SOLD </div>
  <div id="<?=$lotid?>" class="col-md-7 col-lg-6  images expand_view">
    ...
    <span class="slideCount"  id="slideCount_<?=$lotid?>"></span>
            ...
            <div id="cycle_<?=$lotid?>" class="cycle-slideshow"             	
              ...
              <div class="slide_item"><img src="listings/<?=$lotid?>/AUS_Penthouse_Bedroom.jpg" class="img-responsive"></div>              
              <div class="slide_item"><img src="listings/<?=$lotid?>/AUS_PenthouseLiving_looking_out.jpg" class="img-responsive"></div>              
  ...
  <div class="col-md-5 col-lg-6 copy">
    <div class="row">
      <div class="col-xs-12">
        <h1>Spacious contemporary design</h1>
        <p class="lead">601 Little Lonsdale St, Melbourne</p>
        <p>Soaring above the city, this 45th floor sky home skyhome delivers spectacular CBD views. A large open living area features a gas fireplace, adjoining private study and opens to a large entertaining terrace.</p>
      </div>
    </div>
    <div class="row button-row">
      <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
        ...
        <h3 class="pricey"><span>$</span>1,850,000</h3>
      </div>
