...
$('#btn_aus_4503p3').click(function (e) {
  ...
  $(window).stop(true).scrollTo($('#cycle_aus_4503p3'), {
    duration: 600,
    offset: -90
  });
});
...
$('#btn_fp_aus_4502p2').click(function (e) {
  ...
  $(window).stop(true).scrollTo($('#cycle_aus_4502p2'), {
    duration: 600,
    offset: -90
  });
});
...
$('#btn_fp_m1_4503ph3').click(function (e) {
  ...
  $(window).stop(true).scrollTo($('#cycle_m1_4503ph3'), {
    duration: 600,
    offset: -90
  });
});
...
$('#btn_fp_m1_4501ph1').click(function (e) {
  ...
  $(window).stop(true).scrollTo($('#cycle_m1_4501ph1'), {
    duration: 600,
    offset: -90
  });
});
...
$('#btn_sbc_4703z').click(function (e) {
  ...
  $(window).stop(true).scrollTo($('#cycle_sbc_4703z'), {
    duration: 600,
    offset: -90
  });
});
